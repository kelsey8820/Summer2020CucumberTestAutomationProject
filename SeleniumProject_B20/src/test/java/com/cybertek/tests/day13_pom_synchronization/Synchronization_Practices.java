...
public class Synchronization_Practices {
    ...
    public void p40_dynamic_title_test(){
        ...
        // creating the object to be able to use web element
        Loading7Page loading7Page = new Loading7Page();

        // using WebDriverWait to create explicit wait until the title changes
        WebDriverWait wait = new WebDriverWait(Driver.getDriver(), 10);

        // we need to use the object "wait" to setup out expected condition
